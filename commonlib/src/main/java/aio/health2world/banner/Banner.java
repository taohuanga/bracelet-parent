...
import aio.health2world.banner.listener.OnBannerClickListener;
import aio.health2world.banner.listener.OnBannerListener;
import aio.health2world.banner.loader.ImageLoaderInterface;
import aio.health2world.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.shape_radius_banner_select;
    private int mIndicatorUnselectedResId = R.drawable.shape_radius_banner_unselect;
    ...
    public Banner(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorSize = dm.widthPixels / 160;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.shape_radius_banner_select);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.shape_radius_banner_unselect);
     ...
     * the scroll position is changed. This allows the app to apply custom property

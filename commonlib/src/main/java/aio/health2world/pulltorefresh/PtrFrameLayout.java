...
import aio.health2world.pulltorefresh.indicator.PtrIndicator;
import aio.health2world.pulltorefresh.loadmore.DefaultLoadMoreViewFooter;
import aio.health2world.pulltorefresh.loadmore.GridViewHandler;
...
import aio.health2world.pulltorefresh.loadmore.ListViewHandler;
import aio.health2world.pulltorefresh.loadmore.LoadMoreHandler;
import aio.health2world.pulltorefresh.loadmore.OnLoadMoreListener;
import aio.health2world.pulltorefresh.loadmore.OnScrollBottomListener;
import aio.health2world.pulltorefresh.loadmore.RecyclerViewHandler;
import aio.health2world.pulltorefresh.loadmore.RecyclerViewHandler1;
import aio.health2world.pulltorefresh.utils.PtrCLog;
        ...
        if (!hasInitLoadMoreView && isLoadMoreEnable) {
            ...
            if (null == mLoadMoreHandler) {
                if (mContentView instanceof GridView) {
                    ...
                    mLoadMoreHandler = new RecyclerViewHandler1();
                }

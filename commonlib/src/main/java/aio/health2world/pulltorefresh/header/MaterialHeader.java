package aio.health2world.pulltorefresh.header;
...
import aio.health2world.pulltorefresh.PtrUIHandler;
import aio.health2world.pulltorefresh.PtrUIHandlerHook;
...
public class MaterialHeader extends View implements PtrUIHandler {
    ...
    /**
     * 增加者  lishiyou
     * 监听头部是否开始下拉 和以及下拉之后 是否释放两种状态
     */
    private OnHeaderState headerState;
    /**
     * 记录当前的状态 避免处于某种状态时重复调用方法 当状态改变时调用才是我们的目的
     */
    private boolean currentState = false;

    public interface OnHeaderState {
        void state(boolean b);
    }

    public void setOnHeaderStateListener(OnHeaderState headerState) {

package os.bracelets.parents.hx.ui;
...
import os.bracelets.parents.hx.Constant;
import os.bracelets.parents.hx.DemoHelper;
import os.bracelets.parents.hx.domain.EmojiconExampleGroupData;
import os.bracelets.parents.hx.domain.RobotUser;
import os.bracelets.parents.hx.widget.EaseChatRecallPresenter;
...
//        	startActivityForResult(new Intent(getActivity(), ChatRoomDetailsActivity.class).putExtra("roomId", toChatUsername), REQUEST_CODE_GROUP_DETAIL);
    ...
    public void onAvatarClick(String username) {
        ...
        ToastUtil.showShort("UserProfileActivity");
...
//            // voiceCallBtn.setEnabled(false);
            ...
            ToastUtil.showShort("VoiceCallActivity");
        }
    }
...
//                    .putExtra("isComingCall", false));
            ...
            inputMenu.hideExtendMenuContainer();
            ToastUtil.showShort("VideoCallActivity");
        }
    }

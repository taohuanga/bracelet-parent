package os.bracelets.parents.hx;
...
import os.bracelets.parents.hx.db.DemoDBManager;
import os.bracelets.parents.hx.db.InviteMessgeDao;
import os.bracelets.parents.hx.db.UserDao;
import os.bracelets.parents.hx.domain.EmojiconExampleGroupData;
import os.bracelets.parents.hx.domain.InviteMessage;
import os.bracelets.parents.hx.domain.InviteMessage.InviteMessageStatus;
import os.bracelets.parents.hx.domain.RobotUser;
import os.bracelets.parents.hx.parse.UserProfileManager;
import os.bracelets.parents.hx.receiver.HeadsetReceiver;
import os.bracelets.parents.hx.ui.ChatActivity;
import os.bracelets.parents.hx.utils.PreferenceManager;

//import os.bracelets.parents.hx.conference.ConferenceActivity;
//import os.bracelets.parents.hx.conference.LiveActivity;
//import os.bracelets.parents.hx.receiver.CallReceiver;
//import os.bracelets.parents.hx.ui.VideoCallActivity;
//import os.bracelets.parents.hx.ui.VoiceCallActivity;

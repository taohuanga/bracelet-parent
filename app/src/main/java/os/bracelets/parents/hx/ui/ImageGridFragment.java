...
import os.bracelets.parents.hx.domain.VideoEntity;
import os.bracelets.parents.hx.utils.ImageCache;
import os.bracelets.parents.hx.utils.ImageResizer;
import os.bracelets.parents.hx.utils.Utils;
import os.bracelets.parents.hx.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			ToastUtil.showShort("RecorderVideoActivity");
